...
const About = () => (
  <section className={styles.about}>
    <div className={styles.card}>
      ...
      <p>
        Als im Jahre 1946 von einigen Männern und Frauen die Ortsgruppe der NaturFreunde gegründet wurde, konnten sie nicht ahnen, welchen
        Aufschwung diese nehmen würde. Das Vereinsleben entwickelte sich und ein Holzhaus auf dem Spielberg in Hegenlohe (heute Lichtenwald)
        wurde erstellt und mit viel Idealismus wurde dieses weiter ausgebaut und war fortan der Mittelpunkt des Vereinsgeschehens.
        <br />
        <br />
        Aber bald schon wurde dieses Haus zu klein.
        <br />
        <br /> 1968 wurde der Grundstein zum Bau des heutigen „Schurwaldhauses“ der NaturFreunde OG Plochingen-Reichenbach-Lichtenwald
        gelegt.
        <br />
        <br /> Weit über 17000 Arbeitsstunden Eigenleistung der Mitglieder und deren Freunde wurden erbracht, bevor das Haus 1971 der
        Öffentlichkeit übergeben wurde. Das Haus hat jetzt 44 Betten, davon 10 im Matratzenlager- Ein Campingplatz und ein Spielplatz sind
        dem Haus angegliedert.
        <br /> Für Wanderer wurden 40 km Rundwanderwege ausgeschildert.
        <br />
        <br />
...
const Info = () => (
  <section className={styles.about + ' ' + styles.right}>
    <div className={styles.card}>
      ...
      <ul>
        <li>
          für eine sozial-ökologische <a href="https://www.naturfreunde.de/movum-briefe-zur-transformation">Transformation</a> von Politik
          und Gesellschaft
        </li>
        ...
        <li>
          für einen sanften Tourismus (zum Beispiel auf unseren <a href="https://www.naturfreunde.de/natura-trails">Natura Trails</a>, wie
  ...
  <section className={styles.social}>
    <div className={styles.row}>
      <div className={styles.col}>
        ...
        <p>
          Wir beobachten in den Kanälen alles mit dem Hashtag <b>#naturfreundelichtenwald</b>
        </p>
        <br />
        <ul>
          <li>
      ...
      <div className={styles.col}>
        ...
        <p>
          Besonders stolz sind wir auf unser naturpädagogisches Angebot für Grundschulkinder der 1. bis 3. Klasse: die{' '}
          <b>Umweltdetektive</b>!
        </p>
        <p>
      ...
      <div className={styles.col}>
        ...
        <p>
          ...
          <br />
          <br />
          Die große Terasse lädt bei tollem Wetter zum draußen sitzen ein und unser großer Naturspielplatz wie das Ziegengehege bieten auch
          für Kinder Unterhaltung.
          <br />
          <br />
          Unser Haus ist voll bewirtschaftet durch Verpachtung an die Fam. Haug.
          <br /> Die Webseite zum Schurwaldbesen finden sie{' '}
          <a href="http://www.schurwaldbesen.com/" alt="homepage link">
            hier
          </a>
        </p>
      </div>
